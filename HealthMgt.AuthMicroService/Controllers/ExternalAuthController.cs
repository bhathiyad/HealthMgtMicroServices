...
using HealthMgt.AuthMicroService.Auth;
  ...
  public class ExternalAuthController : Controller
  {
    ...
    public async Task<IActionResult> Facebook([FromBody]FacebookAuthViewModel model)
    {
      ...
      if (user == null)
      {
        ...
        await _appDbContext.Customers.AddAsync(new CustomerEntity { IdentityId = appUser.Id, Location = "",Locale = userInfo.Locale,Gender = userInfo.Gender});
